...
// We define all 17 problems with 100% problem-specific authentic content
function addProblem(data) {
  p1_problems[data.id] = data;
}
...
(function () {
  ...
  const arrayExplanations = ${JSON.stringify(p1_problems, null, 2)};
...
fs.writeFileSync(path.join(__dirname, '../js/data/dsa/explanations/array.js'), outContent, 'utf8');
console.log("Successfully generated array.js with " + Object.keys(p1_problems).length + " problems!");
